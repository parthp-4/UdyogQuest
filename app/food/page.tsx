...
export default async function FoodPage() {
  const articles = await getKnowledgeByIndustry("FOOD");
  return (
    <>
      <PageHeader eyebrow="Food businesses" title="Food OS" description="FSSAI, FoSCoS, food processing, state food departments, municipal dependencies, and food-sector schemes from verified records only." />
